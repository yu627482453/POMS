...
public class TFIDFAnalyzer extends UDF {
    ...
    public String evaluate(String line, int topN) {
        TFIDFAnalyzer tfidfAnalyzer = new TFIDFAnalyzer();
        List<Keyword> list = tfidfAnalyzer.analyze(line, topN);
